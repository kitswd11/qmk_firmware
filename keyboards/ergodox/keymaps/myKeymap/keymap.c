...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_UP,          KC_A,         KC_S,    KC_D,   KC_F,    KC_G,
        KC_LEFT,        KC_Z,         KC_X,    KC_C,   KC_V,    KC_B,   KC_LBRC,
        MO(SYMB),       KC_LGUI,      KC_LALT, KC_PLUS,MO(MDIA),
                                                     KC_LSFT, KC_HOME,
                                                              KC_END,
                                        SFT_T(KC_SPC),KC_BSPC,KC_CTRL,
        // right hand
             TG(MDIA),    KC_6,   KC_7,    KC_8,   KC_9,   KC_0,            KC_ESC,
             KC_RPRN,     KC_Y,   KC_U,    KC_I,   KC_O,   KC_P,            KC_BSLS,
                          KC_H,   KC_J,    KC_K,   KC_L,   KC_SCLN,         KC_DOWN,
             KC_RBRC,     KC_N,   KC_M,    KC_COMM,KC_DOT, KC_SLSH,         KC_RIGHT,
                                  MO(MDIA),KC_ASTR,KC_CTRL,KC_RSFT,         MO(SYMB),
             KC_PGUP,     KC_BSPC,
             KC_PGDN,
