 ...
 * |  Shift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  |   \    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LGUI | Alt  |      |      | SYMB |                                       |  VIM | Ctrl | Alt  |Shift | Esc  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | Del  |      |       |      |        |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LT(MDIA), KC_N,   KC_M,    KC_COMM,KC_DOT,  KC_SLSH,         KC_BSLS,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  F11   |  F1  |  F2  |  F3  |  F4  |  F5  | Trs  |           | Trs  |  F6  |  F7  |  F8  |  F9  |  F10 |  F12   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  Trs   |  !   |  @   |  (   |  )   |  '   | Trs  |           | Trs  |  +   |  *   |  7   |  8   |  9   |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  Trs   |  #   |  $   |  [   |  ]   |  "   |------|           |------|  -   |  /   |  4   |  5   |  6   |        |
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_EXLM, KC_AT,   KC_LPRN, KC_RPRN, KC_QUOT,       KC_TRNS,
       KC_TRNS, KC_HASH, KC_DLR,  KC_LBRC, KC_RBRC, LSFT(KC_QUOT),
       KC_TRNS, KC_CIRC, KC_AMPR, KC_LCBR, KC_RCBR, KC_NO,         KC_TRNS,
       ...
       KC_TRNS, KC_PLUS, KC_ASTR, KC_7,   KC_8,    KC_9,    KC_F12,
                KC_MINS, KC_SLSH, KC_4,   KC_5,    KC_6,    KC_TRNS,
       KC_TRNS, KC_PERC, KC_0,    KC_1,   KC_2,    KC_3,    KC_TRNS,
                         KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
...
[MDIA] = KEYMAP(
       ...
       KC_TRNS, KC_WH_D, KC_MS_U, KC_WH_U, KC_TRNS,KC_TRNS, KC_TRNS,
 ...
 * |  Trs   |      |      |      |      |      |      |           | Trs  |      | Prev | ToI  |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  Trs   | ToI  | HOME | PGDN | PGUP | END  |------|           |------| Left | Down |  Up  |Right |      |        |
 * |--------+------+------+------+------+------| Trs  |           | Trs  |------+------+------+------+------+--------|
 * |  Trs   |      | Bspc |      |      |      |      |           |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Trs  | Trs  | Trs  | Trs  | Trs  |                                       | Trs  | Trs  | Trs  | Trs  | Trs  |
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_TRNS,
       KC_TRNS, TO(BASE),KC_HOME, KC_PGDN, KC_PGUP, KC_END,
       ...
       KC_TRNS, KC_NO,   CTL(KC_Z),TO(BASE),KC_NO,   KC_NO,  KC_F12,
       KC_TRNS, KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT,   KC_NO,  KC_TRNS,
       KC_TRNS, KC_NO,   KC_NO,    KC_NO,   KC_NO,   KC_NO,  KC_TRNS,
                         KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
